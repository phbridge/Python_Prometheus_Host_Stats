...
if __name__ == "__main__":
    ...
    cpu_thread = threading.Thread(target=lambda: get_latest_cpu_stats())
    mem_thread = threading.Thread(target=lambda: get_latest_cpu_stats())
    pressure_thread = threading.Thread(target=lambda: get_latest_cpu_stats())
    pi_thread = threading.Thread(target=lambda: get_latest_cpu_stats())
    network_thread = threading.Thread(target=lambda: get_latest_cpu_stats())
    disk_thread = threading.Thread(target=lambda: get_latest_cpu_stats())
